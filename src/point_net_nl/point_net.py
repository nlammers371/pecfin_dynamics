...
class PointNetBackbone(nn.Module):
    ...
    ''' 
    def __init__(self, num_points=2500, num_global_feats=128, local_feat=True):
        ''' Initializers:
...
class PointNetRegHead(nn.Module):
    ''' Segmentation Head '''
    def __init__(self, num_points=2500, num_global_feats=512, num_local_features=64, m=1):
        ...
        # shared MLP
        num_features = num_global_feats + num_local_features # local and global features
