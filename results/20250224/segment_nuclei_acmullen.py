...
experiment_date_vec = ["amullen"] #, "20240712_01", "20240712_02"] #, "20240425", "20240619", "20240620"]
pretrained_model_vec = [pretrained_model] #, pretrained_model0, pretrained_model0] #[pretrained_model0, pretrained_model1, pretrained_model1, pretrained_model0, pretrained_model0]
...
for e, experiment_date in enumerate(experiment_date_vec):
    ...
    cellpose_segmentation(root=root, experiment_date=experiment_date, well_list=well_list,
                          xy_ds_factor=2, cell_diameter=cell_diameter, nuclear_channel=nuclear_channel,
