...
# zarr_path = "/media/nick/hdd02/Cole Trapnell's Lab Dropbox/Nick Lammers/Nick/pecfin_dynamics/built_data/cellpose_output/log-v3/20240424/20240424_well0012_probs.zarr/"
zarr_list = sorted(glob.glob(zarr_path + "*.zarr"))

zarr_ind = 8

raw_zarr = zarr.open(zarr_list[zarr_ind], mode="r")
...
viewer.add_image(raw_zarr, channel_axis=0, scale=scale_vec)
