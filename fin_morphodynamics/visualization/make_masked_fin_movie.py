...
mask_name = os.path.join(mask_directory, file_prefix + "labels_stitched.zarr")
...
xyz_array_norm = np.divide(xyz_array, np.max(xyz_array, axis=0))
inside_flags = hull.contains(xyz_array_norm)
