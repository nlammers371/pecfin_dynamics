...
zarr_path = "/media/nick/hdd02/Cole Trapnell's Lab Dropbox/Nick Lammers/Nick/pecfin_dynamics/built_data/stitched_labels/log-v3/20240424/20240424_well0017_labels_stitched.zarr/"
...
viewer.add_labels(raw_zarr[50], scale=scale_vec)
