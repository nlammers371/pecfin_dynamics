...
root = "Y:\\data\\pecfin_dynamics\\" #"/net/trapnell/vol1/home/nlammers/projects/data/pecfin_dynamics/"
experiment_date_vec = ["20240424"] #, "20240425", "20240619", "20240620"]
pretrained_model_vec = [pretrained_model1] #[pretrained_model0, pretrained_model1, pretrained_model1, pretrained_model0, pretrained_model0]
nuclear_channel_vec = [1] #[0, 1, 1, 0, 0]
well_list = range(0, 18)
