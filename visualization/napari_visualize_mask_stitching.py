...
stitched_mask = io.imread(join(label_directory, out_prefix + "_aff_mask0.tif"))
stitched_mask_p6 = io.imread(join(label_directory, out_prefix + "_aff_mask6.tif"))
stitched_mask_n6 = io.imread(join(label_directory, out_prefix + "_aff_maskn6.tif"))
