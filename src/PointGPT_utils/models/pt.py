...
from PointGPT.segmentation.logger import get_missing_parameters_message, get_unexpected_parameters_message

# from pointnet2_ops import pointnet2_utils
from knn_cuda import KNN
from PointGPT.segmentation.models.pointnet2_utils import PointNetFeaturePropagation
from pointnet2_ops import pointnet2_utils
from PointGPT.segmentation.models.gpt2_seg import GPT_extractor, GPT_generator
import math
from PointGPT.segmentation.extensions.chamfer_dist import ChamferDistanceL1, ChamferDistanceL2
import numpy as np
from PointGPT.segmentation.models.z_order import *
...
class get_model(nn.Module):
    ...
    def forward(self, pts, cls_label):
        ...
        cls_label_one_hot = torch.nn.functional.one_hot(cls_label, B).to(torch.float).view(B, cls_label_one_hot.shape[1], 1)  #cls_label.view(B, 16, 1)
    ...
    def extract_features(self, pts, cls_label):
        B, C, N = pts.shape
        pts = pts.transpose(-1, -2)  # B N 3
